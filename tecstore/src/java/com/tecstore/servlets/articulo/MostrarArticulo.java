 ...
 */
@WebServlet(name = "MostrarArticulo", urlPatterns = {"/articulo/mostrar"})
public class MostrarArticulo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArticuloVO articulo = manager.consultar(idArticulo);
            RequestDispatcher rd = getServletContext().getRequestDispatcher("/articulo/mostrar.jsp");
